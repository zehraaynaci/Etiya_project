...
//delete,save,...
    ...
    @PostMapping("/getUser")
    public ResponseEntity<GenericResponse<User>> getUser(@Valid @RequestBody InquireUserRequest inquireUserRequest) {
        return ResponseEntity.ok(userService.inquireUser(inquireUserRequest));
    }


    @PostMapping("/createUser")
    public ResponseEntity<User> createUser(@Valid @RequestBody CreateUserRequest createUserRequest) throws BusinessValidationException {
